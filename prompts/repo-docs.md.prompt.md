...
- If uncertain, add an _Assumptions_ bullet under the diagram and mark with the heuristics banner.
...
- **Diagrams** (add at least one Mermaid graph when helpful; otherwise mark _Not applicable_)
